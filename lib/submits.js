...
const submitManager = {
    ...
    async getAllData(user, problem) {
        ...
        for (let i = 0; i < submits.length; i++) {
            ...
            datas.push([prob.id, prob.title, usr.realName, usr.enrollmentYear, usr.classNumber, usr.loginName, new Date(submit.updatedAt).toISOString()])
        };
